...
APP_ENV=dev DEBUG=app*,kg:*,nc:* yarn tsn ./scripts/updateRepoReleases.ts
...
runScript(async () => {
  ...
  // const repoFullName = 'johncoatesoss/limitless'
  const repoFullName = 'pwn20wndstuff/Undecimus'
